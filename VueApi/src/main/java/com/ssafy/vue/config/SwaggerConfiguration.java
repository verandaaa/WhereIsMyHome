...
//				.termsOfServiceUrl("https://edu.ssafy.com")
	...
	public Docket starApi() {
		return getDocket("관심목록", Predicates.or(PathSelectors.regex("/star.*")));
	}

	@Bean
	public Docket dealApi() {
		return getDocket("거래정보", Predicates.or(PathSelectors.regex("/deal.*")));
	}
	
	@Bean
	public Docket openApi() {
		return getDocket("네이버api", Predicates.or(PathSelectors.regex("/open.*")));
	}
